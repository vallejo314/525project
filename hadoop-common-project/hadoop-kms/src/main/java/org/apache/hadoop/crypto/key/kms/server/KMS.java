...
public class KMS {
  ...
  protected KeyProviderCryptoExtension provider;
  protected KMSAudit kmsAudit;
  ...
  protected void assertAccess(KMSACLs.Type aclType, UserGroupInformation ugi,
  ...
  protected static KeyProvider.KeyVersion removeKeyMaterial(
  ...
  protected static URI getKeyURI(String name) throws URISyntaxException {
